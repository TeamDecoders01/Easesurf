...
const Mag: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-5 right-5 bg-white shadow-lg p-4 rounded-lg flex flex-col items-center gap-2 border border-gray-300">
            <h2 className="text-lg font-semibold">Magnifier Control</h2>
            <button
                type="button"
                className={`px-4 py-2 rounded-lg text-white ${isActive ? 'bg-red-500 hover:bg-red-600' : 'bg-blue-500 hover:bg-blue-600'}`}
